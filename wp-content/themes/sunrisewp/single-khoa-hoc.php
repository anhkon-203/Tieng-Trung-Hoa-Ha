...
if ($banner){
    ...
    $banner_content_repeat = $banner['content_repeat'];
}
// kĩ năng đạt được sau khóa học
$skill_title = get_field('skill_title');
$skill_repeat = get_field('skill_repeat');
// đội ngũ giáo viên
$team_title = get_field('team_title');
$team_repeat = get_field('team_repeat');
// khoá học khác
$course_title = get_field('course_title');
$course_button = get_field('course_button');
if ($course_button){
    $course_button_title = $course_button['title'];
    $course_button_link = $course_button['link'];
}
// thành tích
...
<!--// banner-->
    <section class="section-detail-course-1">
        ...
        <div class="list">
            <?php foreach ($banner_content_repeat as $item) : ?>
            <div class="child">
                <div class="image">
                    <figure>
                       <?= $item['icon'] ?>
    ...
    <section class="section-detail-course-2">
        <div class="container">
            ...
            <div class="content row">
                <?php foreach ($skill_repeat as $key => $item) : ?>
        ...
        <div class="container">
            ...
            <div class="content">
                <nav class="tabs-control">
                    <ul>
                        <?php foreach ($team_repeat as $key => $item) : ?>
                        <li><a href="#<?php echo $key + 1 ?>"></a>
                            <div class="number">
                                <span>
                                    <?php echo $key + 1; ?>
                                </span>
                ...
                <div class="tabs">
                    <?php foreach ($team_repeat as $key => $item) : ?>
                    <div id="<?php echo $key + 1 ?>" class="tabs-content">
                        <div class="image">
                            <figure>
                                <img src="<?php echo getimage($item['team_img']); ?>" alt="">
                            </figure>
                        </div>
                    </div>
                    <?php endforeach; ?>
...
<!--// khoá học khác-->
    <section class="section-detail-course-4">
        <div class="container">
            ...
            <div class="see-more">
                <a href="<?php echo $course_button_link; ?>">
                    <?php echo $course_button_title; ?>
                </a>
            </div>
        </div>
    </section>
