        ...
        <div class="content row">
            <div class="col-lg-8">
                <div class="col-left"> 
                    <div class="top">
                        <div class="title">
                            <h2>Điểm thi năng lực Hán ngữ quốc tế HSK Viện Khổng Tử Hanu</h2>
                        </div>
                        <div class="date">
                            <figure>
                    ...
                    <div class="desc">
                        <p>Tự tính điểm thi HSK để có sự đánh giá chính xác nhất trình độ tiếng Trung của bạn, từ đó biết được đang bị yếu ở phần kỹ năng nào, bố trí thời gian luyện tập nhiều hơn cho kỹ năng đó, nâng cao dần dần điểm thi HSK lên là mục tiêu luyện thi HSK. Vậy bạn đã biết cách tính điểm HSK các cấp độ chưa, cùng tìm hiểu qua bài viết sau đây.</p>
                        <div class="image">
                            <figure>
                                <img src="./dist/img/img-47.png" alt="">
                            </figure>
                        </div>
                        <div class="name">
                            <h4>Cách tính điểm thi HSK 4</h4>
                        </div>
                        <ul>
                            <li>Điểm thi tối đa phần thi HSK Nghe hiểu là 100 điểm, điểm mỗi câu Nghe hiểu là 100/45 = 2.2 điểm</li>
                            <li>Điểm thi tối đa phần thi HS Đọc hiểu là 100 điểm, điểm mỗi câu Đọc hiểu là 100/40 = 2.5 điểm</li>
                            <li>Điểm tối đa phần thi HSK:</li>
                            <li>Viết là 100 điểm, trong đó điểm tối đa Phần 1 môn</li>
                            <li>Viết là 60 điểm, mỗi câu Viết trong Phần 1 là 60/10 = 6 điểm.</li>
                            <li>Và điểm tối đa phần 2 môn Viết là 40 điểm, mỗi câu Viết trong Phần 2 được 40/5 = 8 điểm.</li>
                            <li>Tổng điểm tối đa của 3 môn Nghe hiểu, Đọc hiểu và Viết là 300 điểm.</li>
                        </ul>
                        <div class="name">
                            <h4>Điều kiện để thi đậu HSK 4</h4>
                        </div>
                        <p>Tổng điểm 180 được coi là đạt, trong đó mỗi môn ít nhất phải đạt 60 điểm là đậu, dưới 60 là trượt môn.</p>
                    </div>
                    <div class="bot">
                        <h4>Tags</h4>
                        <div class="list">
                    ...
                    <div class="hot-news">
                        ...
                        <div class="list">
                            <div class="child">
                                <div class="image">
                                    <figure>
                                        <img src="./dist/img/img-45.png" alt="">
                                    </figure>
                                </div>
                                <div class="text">
                                    <div class="date">
                                    ...
                                    <div class="name">
                                        <a href="#">Vietnam's retail market is waiting for opportunities to explode</a>
                                    </div>
                                </div>
                            </div>
                            <div class="child">
                                <div class="image">
                                    <figure>
                                        <img src="./dist/img/img-46.png" alt="">
                                    </figure>
                                </div>
                                <div class="text">
                                    <div class="date">
            ...
            <div class="list row">
                <div class="col-lg-3">
                    <div class="child">
                        <div class="image">
                            <figure>
                                <img src="./dist/img/img-48.png" alt="">
                            </figure>
                        </div>
                        <div class="text">
                            <div class="date">
                                ...
                                <span>12 tháng 6, 2023</span>
                            </div>
                            <div class="name">
                                <a href="#">The framework agreement to reduce plastic pollution</a>
                            </div>
                        </div>
                    </div>
                </div>
